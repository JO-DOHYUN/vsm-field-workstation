...
private slots:
    ...
    void controlEvidenceStagesSeparateAckFromActualTx() {
        ...
        QCOMPARE(transportRows.size(), 18);
        ...
        QCOMPARE(transportRows.at(7).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("bench_ack_policy"));
        QCOMPARE(transportRows.at(9).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("passive_usb_lifecycle"));
        QCOMPARE(transportRows.at(10).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("csm_uplink"));
        QCOMPARE(transportRows.at(16).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("live_path_trace"));
        QCOMPARE(transportRows.at(17).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("drain_event_trace"));
