...
private slots:
    ...
    void controlEvidenceStagesSeparateAckFromActualTx() {
        ...
        QCOMPARE(transportRows.size(), 17);
        ...
        QCOMPARE(transportRows.at(8).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("passive_usb_lifecycle"));
        QCOMPARE(transportRows.at(9).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("csm_uplink"));
        QCOMPARE(transportRows.at(15).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("live_path_trace"));
        QCOMPARE(transportRows.at(16).toMap().value(QStringLiteral("key")).toString(), QStringLiteral("drain_event_trace"));
