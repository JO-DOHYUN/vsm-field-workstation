...
inline constexpr qsizetype kTypedBoardHealthV7PayloadSize = 296;
...
inline constexpr qsizetype kTypedCapabilityV4PayloadSize = 192;
inline constexpr qsizetype kTypedCapabilityV5PayloadSize = 224;
inline constexpr qsizetype kTypedCapabilityV6PayloadSize = 272;
...
struct TypedCapabilityRecord {
    ...
    bool hasFirmwareIdentity = false;
    quint8 firmwareIdentityVersion = 0;
    bool firmwareDirty = true;
    quint8 firmwareIrqMode = 0;
    quint32 firmwareBuildEpoch = 0;
    quint32 mcpSpiHz = 0;
    quint16 canRecordDrainBudget = 0;
    quint16 serialRingKiB = 0;
    QString firmwareGitSha;
    QString firmwareEnvName;
    bool hasPassivePolicy = false;
    quint8 firmwareProfile = 0;
    quint8 profileLockState = 0;
    quint8 vehicleImpactState = 0;
    bool hostCommandRx = false;
    bool controlPath = false;
    bool usbBackpressureIsolated = false;
    ...
    quint8 busMode[2] = {};
    bool busAckCapable[2] = {};
    bool busErrorFrameCapable[2] = {};
    bool busTransceiverResetSafe[2] = {};
    bool usbCdcDtrSessionRequired = false;
    bool usbCdcDtrSessionOnly = false;
    bool hasPassiveHardwareEvidenceClaims = false;
    quint8 passiveHardwareEvidenceSchema = 0;
    bool hardwareSilentStrapped[2] = {};
    bool galvanicIsolated[2] = {};
    bool powerOffPassive[2] = {};
    bool resetSafe[2] = {};
    bool txdGated[2] = {};
    bool normalEnablePathPopulated[2] = {};
